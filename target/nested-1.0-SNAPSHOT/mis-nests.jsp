...
<html lang="es">
  ...
  <body>
	...
	<div class="secciones-nests">
      ...
      <a class="seccion" href="/ServletSeccionNest?tipo=4"><h3 id="seccion-seleccionada">Mis nests</h3></a>
    </div>
    ...
    %>
     <div class="contenedor-nests">
        ...
        <% 
            ...
            %>
            <h1 style="margin: 1rem" >NO ESTAS APUNTADO A NINGUN NEST</h1>
        <% } else { 
        ...
        %>    
				...
				<% if (nest.getIdOrganizador() != user.getId()) { %>
                                    <div class="participar">
                                        <a href="#popup-inscripcion-<%= nest.getNombre() %>"><span class="material-symbols-outlined icono-participar icono-participar-inverso">shift</span></a>
                                        <h2> <%= participantes %>/<%= nest.getLimitePersonas() %> </h2>
                                    </div>
                                <% } else { %>
                                    <div class="participar">
                                        <a class="boton-solicitar" style=" width: 50%" href="/ServletEliminarNest?id=<%= nest.getIdentificador() %>"><h2>ELIMINAR NEST</h2></a>
                                        <h2> <%= participantes %>/<%= nest.getLimitePersonas() %> </h2>
                                    </div>
                                <% }  %>
			</div>
			<div class="nest-footer">
				...
				<a href="#popup-informacion-<%= nest.getNombre() %>"><h3>+INFORMACIÓN</h3></a>	
                    ...
                    <form action="ServletInscripcion?opcion=2" method="post" id="popup-inscripcion-<%= nest.getNombre() %>" class="overlay">
                        <div class="popup">
                            ...
                            <div class="contenedor-item">
                                    <p>¿Quieres desapuntarte a este Nest?</p>
                                    <button type="submit" class="boton-aceptar" href="ServletInscripcion"><span class="material-symbols-outlined">done</span></button>
