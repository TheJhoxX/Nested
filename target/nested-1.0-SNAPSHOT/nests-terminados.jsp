...
<html lang="es">
  ...
  <body>
    ...
    <div class="secciones-nests">
      ...
      <a class="seccion" href="/ServletSeccionNest?tipo=3"><h3 id="seccion-seleccionada">Terminado</h3></a>
    ...
    %>
     <div class="contenedor-nests">
        ...
        <% 
            ...
            %>
            <h1 style="margin: 1rem" >NO HAY NINGÚN EVENTO TERMINADO PARA EL QUE HAYA PASADO MENOS DE UN DÍA DESDE QUE FINALIZÓ</h1>
        <% } else { 
        ...
        %>    
				...
				<div class="participar">
                                    <h2>¿DISFRUTASTE DE TU NEST?</h2>
					<div class="contenedor-item">
                                                <a class="boton-aceptar" href="ValorarNestServlet?value=1&idNest=<%= nest.getIdentificador() %>&idOrganizador=<%= nest.getIdOrganizador() %>"><span class="material-symbols-outlined">done</span></a>
						<a class="boton-rechazar" href="ValorarNestServlet?value=0&idNest=<%= nest.getIdentificador() %>&idOrganizador=<%= nest.getIdOrganizador() %>"><span class="material-symbols-outlined">close</span></a>
					</div>
